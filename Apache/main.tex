...
\begin{itemize}
	\item Need to set firewall to accept WWW
	\item Add mods using a2enmod command
	\item enable sites in sites available using soft link (ln -s)
\end{itemize}
...
\begin{lstlisting}[
	...
	language=html, % Use Julia functions/syntax highlighting
